...
public class PCLCustomCardEffectEditor<T extends PSkill<?>> extends PCLCustomCardGenericPage {
    ...
    public PCLCustomCardEffectEditor(EffectEditorGroup<T> group, EUIHitbox hb, int index) {
        ...
        origins = new EUIDropdown<>(new OriginRelativeHitbox(hb, MENU_WIDTH, MENU_HEIGHT, AUX_OFFSET, 0)
        ...
        piles = new EUIDropdown<>(new OriginRelativeHitbox(hb, MENU_WIDTH, MENU_HEIGHT, AUX_OFFSET, 0)
