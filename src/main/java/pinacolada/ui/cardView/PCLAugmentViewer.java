...
public class PCLAugmentViewer extends EUIHoverable {
    ...
    public void refreshAugment() {
        ...
        if (augment != null) {
            ...
            augmentButton.tooltip.setTitle(augmentTitle.text).setDescription(!PGR.dungeon.augmentList.isEmpty() ? PGR.core.strings.scp_clickToSlot : PGR.core.strings.scp_noAugments);
