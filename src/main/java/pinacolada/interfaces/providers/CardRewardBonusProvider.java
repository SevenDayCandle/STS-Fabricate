...
public interface CardRewardBonusProvider {
    ...
    public static CardRewardBundle getGoldBundle(AbstractCard card, int gold) {
    ...
    public static CardRewardBundle getMaxHPBundle(AbstractCard card, int maxHP) {
    ...
    public static void receiveGold(CardRewardBundle bundle) {
        PCLSFX.play(PCLSFX.GOLD_GAIN);
        AbstractDungeon.player.gainGold(bundle.amount);
    }

    public static void receiveMaxHP(CardRewardBundle bundle) {
        AbstractDungeon.player.increaseMaxHp(bundle.amount, true);
    }

    public static void receiveUpgrade(CardRewardBundle bundle) {
