...
public class PMove_EvokeOrb extends PMove<PField_Orb> {
    ...
    public PMove_EvokeOrb(int amount, int orbs, PCLOrbData... orb) {
    ...
    public PMove_EvokeOrb(int amount, PCLOrbData... orb) {
        this(amount, 1, orb);
    }
    ...
    public String getSubText(PCLCardTarget perspective, Object requestor) {
        String orbStr = fields.getOrbExtraString(requestor);
        return amount == 1 ? TEXT.act_evoke(orbStr) : TEXT.act_evokeXTimes(orbStr, getAmountRawString(requestor));
    }
