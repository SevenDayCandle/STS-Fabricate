...
@VisibleSkill
public class PCond_HaveDrawn extends PCond_HaveCard {
    public static final PSkillData<PField_CardCategory> DATA = register(PCond_HaveDrawn.class, PField_CardCategory.class)
            .setOrigins(PCLCardSelection.Manual)
            .setDestinations(PCLCardSelection.Manual)
            .setGroups(PCLCardGroupHelper.DrawPile)
            .noTarget();

    public PCond_HaveDrawn() {
        this(1);
    }

    public PCond_HaveDrawn(int amount) {
        super(DATA, amount, PCLCardGroupHelper.DrawPile);
    }

    public PCond_HaveDrawn(PSkillSaveData content) {
        super(DATA, content);
    }
