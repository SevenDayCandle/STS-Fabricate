...
public class PCond_IsDefending extends PPassiveCond<PField_Not> {
    ...
    public String getSampleText(PSkill<?> callingSkill, PSkill<?> parentSkill) {
        return isUnderWhen(callingSkill, parentSkill) ? TEXT.cond_whenSingle(PGR.core.tooltips.block.present()) : TEXT.cond_xIsY(TEXT.subjects_target, PGR.core.tooltips.block.progressive());
    }

    @Override
    public String getSubText(PCLCardTarget perspective) {
        return getTargetIsString(getTargetForPerspective(perspective), fields.not ? TEXT.cond_not(PGR.core.tooltips.block.progressive()) : PGR.core.tooltips.block.progressive());
    }
}
