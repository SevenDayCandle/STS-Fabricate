...
@VisibleSkill
public class PCond_HaveLastReshuffled extends PCond_HaveLastCard {
    public static final PSkillData<PField_CardCategory> DATA = register(PCond_HaveLastReshuffled.class, PField_CardCategory.class)
            .setOrigins(PCLCardSelection.Manual)
            .setDestinations(PCLCardSelection.Manual)
            .setGroups(PCLCardGroupHelper.DrawPile)
            .noTarget();

    public PCond_HaveLastReshuffled() {
        this(1);
    }

    public PCond_HaveLastReshuffled(int amount) {
        super(DATA, amount, PCLCardGroupHelper.DrawPile);
    }

    public PCond_HaveLastReshuffled(PSkillSaveData content) {
        super(DATA, content);
    }
