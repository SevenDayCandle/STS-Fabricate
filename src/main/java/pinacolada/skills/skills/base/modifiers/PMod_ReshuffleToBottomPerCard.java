...
public class PMod_ReshuffleToBottomPerCard extends PMod_Do
{

    public static final PSkillData DATA = register(PMod_ReshuffleToBottomPerCard.class, CardGroupFull)
            .selfTarget()
            .setGroups(PCLCardGroupHelper.DrawPile, PCLCardGroupHelper.DiscardPile, PCLCardGroupHelper.Hand);

    public PMod_ReshuffleToBottomPerCard(PSkillSaveData content)
    {
        super(content);
    }

    public PMod_ReshuffleToBottomPerCard()
    {
        super(DATA);
    }

    public PMod_ReshuffleToBottomPerCard(int amount, PCLCardGroupHelper... groups)
    {
        super(DATA, PCLCardTarget.None, amount, groups);
    }

    public PMod_ReshuffleToBottomPerCard(int amount, List<PCLCardGroupHelper> groups)
    {
