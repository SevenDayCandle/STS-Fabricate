    ...
    public String getConditionText(PCLCardTarget perspective, Object requestor, String childText) {
        if (fields.not) {
            return TEXT.cond_xConditional(childText,
                    fields.random ? TEXT.cond_perThisCombat(getAmountRawString(requestor), fields.getOrbAndStringSingular(), PCLCoreStrings.past(PGR.core.tooltips.evoke)) : TEXT.cond_perThisTurn(getAmountRawString(requestor), fields.getOrbAndStringSingular(), PCLCoreStrings.past(PGR.core.tooltips.evoke)));
        }
