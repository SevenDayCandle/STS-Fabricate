...
public abstract class PMod_BonusOnHas extends PMod_BonusOn<PField_CardCategory>
{
    ...
    {
        return fields.forced ? TEXT.cond_ifYouDidThisCombat(PCLCoreStrings.past(getActionTooltip()), EUIRM.strings.numNoun(getExtraRawString(), fields.getFullCardRandomOrString(getExtraRawString()))) :
                TEXT.cond_ifYouDidThisTurn(PCLCoreStrings.past(getActionTooltip()), EUIRM.strings.numNoun(getExtraRawString(), fields.getFullCardRandomOrString(getExtraRawString())));
    }
