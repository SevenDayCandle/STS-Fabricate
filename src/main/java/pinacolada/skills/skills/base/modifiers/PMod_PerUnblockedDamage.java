...
@VisibleSkill
public class PMod_PerUnblockedDamage extends PMod_Per<PField_Empty>
{

    public static final PSkillData<PField_Empty> DATA = register(PMod_PerUnblockedDamage.class, PField_Empty.class).selfTarget();
