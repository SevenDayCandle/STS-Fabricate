...
public class PMod_PerCardPlayed extends PMod_Per<PField_CardCategory>
{
    ...
    public String getText(boolean addPeriod)
    {
        ...
        return (fields.forced ? TEXT.cond_perThisCombat(childString, getConditionText(), PGR.core.tooltips.play.past()) : TEXT.cond_perThisTurn(childString, getConditionText(), PGR.core.tooltips.play.past()))
