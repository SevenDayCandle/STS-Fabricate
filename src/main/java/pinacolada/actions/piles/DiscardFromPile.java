...
public class DiscardFromPile extends SelectFromPile {
    ...
    public DiscardFromPile(String sourceName, int amount, PCLCardSelection origin, CardGroup... groups) {
    ...
    public DiscardFromPile(String sourceName, AbstractCreature target, int amount, PCLCardSelection origin, CardGroup... groups) {
