...
public class PCLPowerData extends PCLGenericData<AbstractPower> implements KeywordProvider {
    ...
    public static final PCLPowerData Curiosity = registerBaseBuff(CuriosityPower.class, CuriosityPower.POWER_ID, PGR.core.tooltips.curiosity).setImageRegion(ICON_CURIOSITY).setEndTurnBehavior(PCLPowerData.Behavior.Permanent);
