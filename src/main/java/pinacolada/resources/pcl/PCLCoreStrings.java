...
public class PCLCoreStrings extends PCLStrings {
    ...
    public final String cedit_liquidColor = cedit.TEXT[66];
    public final String cedit_hybridColor = cedit.TEXT[67];
    public final String cedit_spotsColor = cedit.TEXT[68];
    ...
    public final String cetut_effectPrimary = cetut.TEXT[13];
    public final String cetut_effectTurnDelay = cetut.TEXT[14];
    public final String cetut_effectChoices = cetut.TEXT[15];
    public final String cetut_effectMultiCondition = cetut.TEXT[16];
    public final String cetut_effectBranchCondition = cetut.TEXT[17];
    public final String cetut_imageSelect = cetut.TEXT[18];
    public final String cetut_imageCrop = cetut.TEXT[19];
    public final String cetut_maxUpgrades = cetut.TEXT[20];
    public final String cetut_maxCopies = cetut.TEXT[21];
    public final String cetut_idSuffix = cetut.TEXT[22];
    public final String cetut_nameLanguage = cetut.TEXT[23];
    public final String cetut_rarity = cetut.TEXT[24];
    public final String cetut_type = cetut.TEXT[25];
    public final String cetut_cardTarget = cetut.TEXT[26];
    public final String cetut_amount = cetut.TEXT[27];
    public final String cetut_attackType = cetut.TEXT[28];
    public final String cetut_attackEffect = cetut.TEXT[29];
    public final String cetut_hitCount = cetut.TEXT[30];
    public final String cetut_blockCount = cetut.TEXT[31];
    public final String cetut_loadFromCardScreen = cetut.TEXT[32];
    public final String cetut_branchUpgrade = cetut.TEXT[33];
    public final String cetut_useParent = cetut.TEXT[34];
    public final String cetut_required1 = cetut.TEXT[35];
    public final String cetut_required2 = cetut.TEXT[36];
    public final String cetut_passive = cetut.TEXT[37];
    public final String cetut_when = cetut.TEXT[38];
    public final String cetut_bonus = cetut.TEXT[39];
    public final String cetut_nodeTutorial = cetut.TEXT[40];
    public final String cetut_blankPrimary = cetut.TEXT[41];
    public final String cetut_blankProxy = cetut.TEXT[42];
    public final String cetut_relicRarity = cetut.TEXT[43];
    public final String cetut_landingSound = cetut.TEXT[44];
    public final String cetut_addToEffect = cetut.TEXT[45];
    public final String cetut_primaryWarning = cetut.TEXT[46];
    public final String cetut_corruptedWarning = cetut.TEXT[47];
    public final String cetut_undo = cetut.TEXT[48];
    public final String cetut_openFolder = cetut.TEXT[49];
    public final String cetut_topBarTutorial = cetut.TEXT[50];
    public final String cetut_potionRarity = cetut.TEXT[51];
    public final String cetut_potionSize = cetut.TEXT[52];
    public final String cetut_potionEffect = cetut.TEXT[53];
    public final String cetut_potionColor = cetut.TEXT[54];
    // Card Pile
    ...
    public final String act_obtainAmount(Object amount, Object card) {
        return actFmt(26, amount, card);
    }
    public final String act_pay(Object amount, Object power) {
        return actFmt(27, amount, power);
    }
