...
public class PCLCoreStrings extends AbstractStrings {
    ...
    public final String subjects_unblockedX = subjects.TEXT[56];
    public final String subjects_x = subjects.TEXT[57];
    public final String subjects_you = subjects.TEXT[58];
    public final String subjects_yourFirstX = subjects.TEXT[59];
    public final String subjects_yourX = subjects.TEXT[60];
    public final String subjects_xOfY = subjects.TEXT[61];
    public final String subjects_xOnY = subjects.TEXT[62];
    public final String subjects_xOrLessY = subjects.TEXT[63];
    public final String subjects_xThisCombat = subjects.TEXT[64];
    public final String subjects_xThisTurn = subjects.TEXT[65];
    public final String subjects_xTimes = subjects.TEXT[66];
    public final String subjects_xUntilY = subjects.TEXT[67];
    public final String subjects_xWithY = subjects.TEXT[68];
    public final String subjects_xCost = subjects.TEXT[69];
    // Tutorial
