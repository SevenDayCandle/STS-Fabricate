...
public class PCLCoreTooltips extends PCLTooltips {
    ...
    public EUIKeywordTooltip kill = EUIKeywordTooltip.findByID("Kill").showText(false).canHighlight(false);
    public EUIKeywordTooltip maxHP = EUIKeywordTooltip.findByID("Max HP").showText(false).canHighlight(false);
    public EUIKeywordTooltip normalDamage = EUIKeywordTooltip.findByID("Normal Damage").showText(false).canHighlight(false);
    public EUIKeywordTooltip orb = EUIKeywordTooltip.findByID("Orb").showText(false).canHighlight(false);
