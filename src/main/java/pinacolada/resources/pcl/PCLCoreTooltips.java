...
public class PCLCoreTooltips extends PCLTooltips
{
    ...
    public EUITooltip affinityLight = EUITooltip.findByID("~Light Affinity").showText(false);
    public EUITooltip affinityDark = EUITooltip.findByID("~Dark Affinity").showText(false);
    ...
    public PCLCoreTooltips()
    {
        ...
        EUITooltip.registerID(PCLAffinity.Light.getAffinitySymbol(), affinityLight);
        EUITooltip.registerID(PCLAffinity.Dark.getAffinitySymbol(), affinityDark);
    ...
    public void initializeIcons()
    {
        ...
        affinityLight.setIconFunc(PCLAffinity.Light::getTextureRegion).setIconSizeMulti(0.85f, 0.85f);
        affinityDark.setIconFunc(PCLAffinity.Dark::getTextureRegion).setIconSizeMulti(0.85f, 0.85f);
        ...
        blur.setIconFromPowerRegion("blur");
        buffer.setIconFromPowerRegion("buffer");
        constricted.setIconFromPowerRegion("constricted");
        curlUp.setIconFromPowerRegion("closeUp");
        demonForm.setIconFromPowerRegion("demonForm");
        dexterity.setIconFromPowerRegion("dexterity");
        envenom.setIconFromPowerRegion("envenom");
        flight.setIconFromPowerRegion("flight");
        frail.setIconFromPowerRegion("frail");
        focus.setIconFromPowerRegion("focus");
        intangible.setIconFromPowerRegion("intangible");
        lockOn.setIconFromPowerRegion("lockon");
        malleable.setIconFromPowerRegion("malleable");
        metallicize.setIconFromPowerRegion("metallicize");
        nextTurnBlock.setIconFromPowerRegion("defenseNext");
        nextTurnDraw.setIconFromPowerRegion("carddraw");
        nextTurnDrawLess.setIconFromPowerRegion("lessdraw");
        nextTurnDrawLess.setIconFromPowerRegion("lessdraw");
        noxiousFumes.setIconFromPowerRegion("fumes");
        platedArmor.setIconFromPowerRegion("platedarmor");
        poison.setIconFromPowerRegion("poison");
        rebound.setIconFromPowerRegion("rebound");
        ritual.setIconFromPowerRegion("ritual");
        shackles.setIconFromPowerRegion("shackle");
        slow.setIconFromPowerRegion("slow");
        strength.setIconFromPowerRegion("strength");
        thorns.setIconFromPowerRegion("thorns");
        thousandCuts.setIconFromPowerRegion("thousandCuts");
        vigor.setIconFromPowerRegion("vigor");
        weak.setIconFromPowerRegion("weak");
        vulnerable.setIconFromPowerRegion("vulnerable");
